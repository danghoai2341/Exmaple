...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Student student2 = new Student("Bod", 22, 92.0, 88.5);
        ...
        //Console.WriteLine($"Student 2: {student2.Name}, Age: {student2.Age}, Math Score: {student2.MathScore}, English Score: {student2.EnglishScore}");
